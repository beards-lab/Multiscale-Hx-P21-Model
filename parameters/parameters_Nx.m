function [adjpars,UB,LB,data] = parameters_Nx(data)

 %{ 
    Assignment and/or nominal calculation of all model parameters for Nx. 
...
% Assume end-diastolic sarcomere length (um) 
SL_d    = 2.0;  
...
K_D     = 0.194;    % ADP unattachment rate 
K_T     = 0.4897;   % ATP unattachment rate
...
k_off_RV = 723.8520;  % manually tuned parameter!
